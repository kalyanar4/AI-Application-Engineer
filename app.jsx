...
function App() {
  ...
  const capstoneTiles = window.CAPSTONES.map((c, i) => ({
    ...
    domain: c.domain,
    color: ['pink', 'mustard', 'teal-deep', 'emerald', 'amber', 'rust'][i % 6]
  }));
    ...
    <React.Fragment>
      <nav className="nav" aria-label="Primary">
        <div className="nav__brand">
          ...
          <span><b>Java to AI</b> Roadmap</span>
        </div>
        <div className="nav__right">
          <div className="nav__meta" aria-hidden="true">
            <span><b>26</b> weeks</span>
            <span><b>{window.ROADMAP.length}</b> phases</span>
            <span><b>{window.CAPSTONES.length}</b> projects</span>
          </div>
          <button
            type="button"
      ...
      <header className="hero" data-screen-label="01 Hero">
        ...
        <div className="hero__eyebrow">
          ...
          Personalized Portfolio Roadmap · 26 Weeks · Enterprise AI Projects
        </div>
        <h1 className="hero__title">
          Java Developer to<br />
          <span className="hero__title-100x">AI Application Engineer</span><br />
          <em>Roadmap.</em>
        </h1>
        <p className="hero__sub">
          A focused transition plan for a <em>Senior Java / Spring Boot Developer</em> moving into
          AI Application Engineering and Agent Engineering. The roadmap builds on enterprise
          delivery, AWS, DevOps, and full-stack experience to produce real portfolio systems.
        </p>
      ...
      <section className="agenda reveal" ref={agendaRef} data-screen-label="02 Agenda">
        <div className="agenda__head">
          <h2 className="agenda__title">What this roadmap <em>builds.</em></h2>
          <div className="agenda__sub">
            A practical path from Java enterprise engineering to AI applications, RAG systems,
            agent workflows, and production AWS deployment.
          </div>
        </div>
        ...
        <div className="agenda__projects-head">
          <span className="agenda__projects-label">◆ AI Portfolio Projects</span>
      ...
      <section className="instructor reveal" data-screen-label="03 Instructor">
        <div className="instructor__card">
          <div className="instructor__photo">
            <div className="instructor__monogram" aria-hidden="true">AI</div>
          </div>
          <div className="instructor__body">
            <div className="instructor__label">Professional Positioning</div>
            <h3 className="instructor__name">My Role Target</h3>
            <div className="instructor__role">Senior Java Full Stack Developer → AI Application Engineer → Agent Engineer</div>
            <p className="instructor__bio">
              This roadmap builds on a senior engineering base: <span>Java, Spring Boot, Angular, React,
              AWS, Jenkins, Docker, Terraform, and Azure DevOps</span>. The goal is to move deliberately
              from enterprise full-stack delivery into <span>AI application engineering, RAG systems,
              agent workflows, and AWS production deployment</span>.
            </p>
            <div className="instructor__chips">
              <span className="instructor__chip">Current: Senior Java Full Stack Developer</span>
              <span className="instructor__chip">6 Months: AI Application Engineer</span>
              <span className="instructor__chip">12 Months: Agent Engineer / GenAI Developer</span>
              <span className="instructor__chip">24 Months: AI Solutions Engineer / AI Architect</span>
              <span className="instructor__chip">SERV · IBM · Cognizant</span>
              <span className="instructor__chip">AWS · DevOps · Full Stack</span>
            </div>
          </div>
          <div className="instructor__cta">
            <div className="instructor__connect-label">Primary target</div>
            <div className="instructor__target">AI Application Engineer</div>
          </div>
        </div>
      </section>
        ...
        {window.ROADMAP.map((phase, i) => (
          <article key={phase.id} className="phase"
            ...
            <div className="phase__index">
              ...
              {phase.capstone && (
                <div className="phase__capstone-pill">Project {phase.capstone}</div>
              )}
            </div>
      ...
      <section className="capstones reveal" data-screen-label="Capstones">
        <div className="capstones__eyebrow">AI Portfolio Projects</div>
        <h2 className="capstones__title">Portfolio work grounded in <em>production reality.</em></h2>
        <p className="capstones__intro">
          Each project is framed as a business problem with architecture, features, stack,
          learning outcome, and placeholders for a public repository and demo.
        </p>
          ...
          {window.CAPSTONES.map((c, i) => (
            <article key={c.n}
              ...
              <div className="capstone__left">
                ...
                <div className="capstone__problem">
                  <span className="capstone__field-label">Problem</span>
                  {c.problem}
                </div>
                <div className="capstone__architecture">
                  <span className="capstone__field-label">Architecture</span>
                  {c.architecture}
                </div>
                {c.features && (
                  <div className="capstone__features">
                    <span className="capstone__field-label">Features</span>
                    <div className="capstone__feature-list">
                      {c.features.map((f, fi) => (
                        <span key={fi} className="capstone__feature-pill">{f}</span>
                      ))}
                    </div>
                  </div>
                )}
              ...
              <div className="capstone__build">
                <div className="capstone__build-label">Project brief</div>
                {c.build.map((b, i) => (
      ...
      <section className="outscope reveal" data-screen-label="Out of scope">
        <div className="outscope__head">
          <div className="outscope__eyebrow">◇ Career direction</div>
          <h2 className="outscope__title">My Role <em>Target.</em></h2>
          <p className="outscope__intro">
            The objective is a credible transition from senior enterprise software delivery
            into AI application engineering, agent engineering, and AI solution architecture.
          </p>
        </div>
      ...
      <section className="next reveal" data-screen-label="Where to go from here">
        <div className="next__head">
          <div className="next__eyebrow">→ Weekly cadence</div>
          <h2 className="next__title">Weekly Execution <em>Plan.</em></h2>
          <p className="next__intro">
            Every week should create visible progress: learn one focused topic, build one
            concrete feature, document the decision-making, and publish the result.
          </p>
        </div>
      ...
      <footer className="footer reveal">
        <h2 className="footer__title">
          Build the portfolio that proves the <em>role transition.</em>
        </h2>
        <div className="footer__meta">26 weeks · {window.ROADMAP.length} phases · {totalSections} modules · {window.CAPSTONES.length} portfolio projects</div>
      </footer>
    </React.Fragment>
  );
}
